// src/app/g/[slug]/amenities/page.tsx
...
export default async function AmenitiesPage({ params }: PageProps<{ slug: string }>) {
  ...
  const s = property.sections.find(x => x.kind === 'AMENITIES') ?? null;
  ...
  return (
    <main className="p-6 max-w-xl mx-auto space-y-4">
      ...
      <h1 className="text-3xl font-bold" style={{ color: primary }}>{s?.title ?? 'Amenities'}</h1>
